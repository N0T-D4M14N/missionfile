...
/* Database Related Settings */
    ...
    max_time_before_restart = 5; //sets the how many minutes a player has before a restart, to save his vehicle/s
    max_saved_vehicles = 5; //defines how many vehicles can be saved during the restart, by a single player
